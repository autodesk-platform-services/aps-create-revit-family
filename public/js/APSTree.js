...
async function createFamily( params , targetFolder){
  ...
  jQuery.post({
    url: '/api/aps/da4revit/v1/families',
...
function deleteFolder(node){
  ...
  $.ajax({
    url: '/api/aps/datamanagement/v1/folders/' + encodeURIComponent(node.id),
    type: "delete",
    dataType: "json",
    success: function (res) {
      def.resolve(res);
...
function createNamedFolder(node, folderName) {
  ...
  jQuery.post({
    url: '/api/aps/datamanagement/v1/folders',
...
function cancelWorkitem(workitemId) {
  ...
  $.ajax({
    url: '/api/aps/da4revit/v1/families/' + encodeURIComponent(workitemId),
    type: "delete",
    // dataType: "json",
    // data: JSON.stringify({
